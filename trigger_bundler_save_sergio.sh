#!/bin/bash
    ...
    (mogrify -resize 50% /var/www/parchmentwebsite/uploads/$1/$2/*.jpg; mogrify -resize 50% /var/www/parchmentwebsite/uploads/$1/$2/*.png; sh bundler.sh config$2.txt /var/www/parchmentwebsite/output/bundler/$2/; mkdir -p /var/www/parchmentwebsite/downloads/$1/$2; chmod -R 777 /var/www/parchmentwebsite/downloads/$1/$2; mv /var/www/parchmentwebsite/output/bundler/$2/bundle /var/www/parchmentwebsite/downloads/$1/$2; echo "Please go to our services page to download the flattened parchment. Quote your dataset ID $2 when downloading the dataset." | mail -s "Your dataset is available" $1) &
